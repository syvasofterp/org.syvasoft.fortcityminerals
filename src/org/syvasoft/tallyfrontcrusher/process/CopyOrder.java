...
public class CopyOrder extends SvrProcess
{
	...
	{
		if (log.isLoggable(Level.INFO)) log.info("C_Order_ID=" + RecordId 
		...
		//
		MOrder from = new MOrder (getCtx(), RecordId, get_TrxName());
		...
		{
			MOrder original = new MOrder (getCtx(), RecordId, get_TrxName());
