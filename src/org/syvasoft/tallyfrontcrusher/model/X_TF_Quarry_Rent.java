...
/** Generated Model for TF_Quarry_Rent
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_TF_Quarry_Rent extends PO implements I_TF_Quarry_Rent, I_Persistent 
{
    ...
    public X_TF_Quarry_Rent (Properties ctx, int TF_Quarry_Rent_ID, String trxName)
    {
      super (ctx, TF_Quarry_Rent_ID, trxName);
      /** if (TF_Quarry_Rent_ID == 0)
        {
			setDateAcct (new Timestamp( System.currentTimeMillis() ));
			setIsCalculated (true);
// Y
			setNoOfLoad (Env.ZERO);
			setProcessed (false);
			setTF_Quarry_ID (0);
			setTF_Quarry_Rent_ID (0);
        } */
    }

    /** Load Constructor */
    public X_TF_Quarry_Rent (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TF_Quarry_Rent[")
	...
	/** Set TF_Quarry_Rent_UU.
		@param TF_Quarry_Rent_UU TF_Quarry_Rent_UU	  */
	public void setTF_Quarry_Rent_UU (String TF_Quarry_Rent_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TF_Quarry_Rent_UU, TF_Quarry_Rent_UU);
	}

	/** Get TF_Quarry_Rent_UU.
		@return TF_Quarry_Rent_UU	  */
	public String getTF_Quarry_Rent_UU () 
	{
		return (String)get_Value(COLUMNNAME_TF_Quarry_Rent_UU);
	}
}