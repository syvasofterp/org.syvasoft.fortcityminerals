...
/** Generated Model for TF_Jobwork_ItemIssue
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_TF_Jobwork_ItemIssue extends PO implements I_TF_Jobwork_ItemIssue, I_Persistent 
{
      ...
      /** if (TF_Jobwork_ItemIssue_ID == 0)
        {
			...
			setM_Warehouse_ID (0);
			setProcessed (false);
			setTF_Jobwork_ItemIssue_ID (0);
        } */
    }

    /** Load Constructor */
    public X_TF_Jobwork_ItemIssue (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TF_Jobwork_ItemIssue[")
	...
	/** Set Issue to Jobwork.
		@param TF_Jobwork_ItemIssue_ID Issue to Jobwork	  */
	public void setTF_Jobwork_ItemIssue_ID (int TF_Jobwork_ItemIssue_ID)
	{
		if (TF_Jobwork_ItemIssue_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_TF_Jobwork_ItemIssue_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_TF_Jobwork_ItemIssue_ID, Integer.valueOf(TF_Jobwork_ItemIssue_ID));
	}

	/** Get Issue to Jobwork.
		@return Issue to Jobwork	  */
	public int getTF_Jobwork_ItemIssue_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_TF_Jobwork_ItemIssue_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set TF_Jobwork_ItemIssue_UU.
		@param TF_Jobwork_ItemIssue_UU TF_Jobwork_ItemIssue_UU	  */
	public void setTF_Jobwork_ItemIssue_UU (String TF_Jobwork_ItemIssue_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TF_Jobwork_ItemIssue_UU, TF_Jobwork_ItemIssue_UU);
	}

	/** Get TF_Jobwork_ItemIssue_UU.
		@return TF_Jobwork_ItemIssue_UU	  */
	public String getTF_Jobwork_ItemIssue_UU () 
	{
		return (String)get_Value(COLUMNNAME_TF_Jobwork_ItemIssue_UU);
	}
}