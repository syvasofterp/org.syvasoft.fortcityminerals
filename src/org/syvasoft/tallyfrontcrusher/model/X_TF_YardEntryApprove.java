...
/** Generated Model for TF_YardEntryApprove
 *  @author iDempiere (generated) 
 *  @version Release 4.1 - $Id$ */
public class X_TF_YardEntryApprove extends PO implements I_TF_YardEntryApprove, I_Persistent 
{
...
// @#Date@
    ...
    /** Load Constructor */
    public X_TF_YardEntryApprove (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TF_YardEntryApprove[")
	...
	/** Set TF_YardEntryApprove_UU.
		@param TF_YardEntryApprove_UU TF_YardEntryApprove_UU	  */
	public void setTF_YardEntryApprove_UU (String TF_YardEntryApprove_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TF_YardEntryApprove_UU, TF_YardEntryApprove_UU);
	}

	/** Get TF_YardEntryApprove_UU.
		@return TF_YardEntryApprove_UU	  */
	public String getTF_YardEntryApprove_UU () 
	{
		return (String)get_Value(COLUMNNAME_TF_YardEntryApprove_UU);
	}
}