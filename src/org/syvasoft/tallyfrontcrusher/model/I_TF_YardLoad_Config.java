...
/** Generated Interface for TF_YardLoad_Config
 *  @author iDempiere (generated) 
 *  @version Release 4.1
 */
@SuppressWarnings("all")
public interface I_TF_YardLoad_Config 
{

    /** TableName=TF_YardLoad_Config */
    public static final String Table_Name = "TF_YardLoad_Config";
    ...
    /** Column name SalesTonnagePerLoad */
    public static final String COLUMNNAME_SalesTonnagePerLoad = "SalesTonnagePerLoad";
    ...
    /** Column name TF_YardLoad_Config_ID */
    public static final String COLUMNNAME_TF_YardLoad_Config_ID = "TF_YardLoad_Config_ID";
    ...
    /** Column name TF_YardLoad_Config_UU */
    public static final String COLUMNNAME_TF_YardLoad_Config_UU = "TF_YardLoad_Config_UU";
