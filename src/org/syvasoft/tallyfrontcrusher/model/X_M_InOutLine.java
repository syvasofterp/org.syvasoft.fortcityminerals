...
// 1
	...
	/** Set Create Serial Nos from RMA Line.
		@param CreateSerNos Create Serial Nos from RMA Line	  */
	public void setCreateSerNos (String CreateSerNos)
	{
		set_Value (COLUMNNAME_CreateSerNos, CreateSerNos);
	}

	/** Get Create Serial Nos from RMA Line.
		@return Create Serial Nos from RMA Line	  */
	public String getCreateSerNos () 
	{
		return (String)get_Value(COLUMNNAME_CreateSerNos);
	}
	...
	{
		set_Value (COLUMNNAME_GenerateSerNo, GenerateSerNo);
	}

	/** Get Generate Serial No.
		@return Generate Serial No	  */
	public String getGenerateSerNo () 
	{
		return (String)get_Value(COLUMNNAME_GenerateSerNo);
	}
