...
/** Generated Model for TF_TOrder
 *  @author iDempiere (generated) 
 *  @version Release 5.1 - $Id$ */
public class X_TF_TOrder extends PO implements I_TF_TOrder, I_Persistent 
{
    ...
    public X_TF_TOrder (Properties ctx, int TF_TOrder_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_TF_TOrder (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TF_TOrder[")
	...
	/** Set TF_TOrder_UU.
		@param TF_TOrder_UU TF_TOrder_UU	  */
	public void setTF_TOrder_UU (String TF_TOrder_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TF_TOrder_UU, TF_TOrder_UU);
	}

	/** Get TF_TOrder_UU.
		@return TF_TOrder_UU	  */
	public String getTF_TOrder_UU () 
	{
		return (String)get_Value(COLUMNNAME_TF_TOrder_UU);
	}
}