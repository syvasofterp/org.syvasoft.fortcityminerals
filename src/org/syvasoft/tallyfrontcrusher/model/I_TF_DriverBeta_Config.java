...
/** Generated Interface for TF_DriverBeta_Config
 *  @author iDempiere (generated) 
 *  @version Release 5.1
 */
@SuppressWarnings("all")
public interface I_TF_DriverBeta_Config 
{

    /** TableName=TF_DriverBeta_Config */
    public static final String Table_Name = "TF_DriverBeta_Config";
    ...
    /** Column name DriverBetaAmount */
    public static final String COLUMNNAME_DriverBetaAmount = "DriverBetaAmount";
    ...
    /** Column name TF_DriverBeta_Config_ID */
    public static final String COLUMNNAME_TF_DriverBeta_Config_ID = "TF_DriverBeta_Config_ID";
    ...
    /** Column name TF_DriverBeta_Config_UU */
    public static final String COLUMNNAME_TF_DriverBeta_Config_UU = "TF_DriverBeta_Config_UU";
