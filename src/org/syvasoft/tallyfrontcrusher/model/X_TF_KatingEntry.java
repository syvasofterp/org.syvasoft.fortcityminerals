...
/** Generated Model for TF_KatingEntry
 *  @author iDempiere (generated) 
 *  @version Release 4.1 - $Id$ */
public class X_TF_KatingEntry extends PO implements I_TF_KatingEntry, I_Persistent 
{
    ...
    /** Load Constructor */
    public X_TF_KatingEntry (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TF_KatingEntry[")
	...
	/** Set Kating Entry.
		@param TF_KatingEntry_ID Kating Entry	  */
	public void setTF_KatingEntry_ID (int TF_KatingEntry_ID)
	{
		if (TF_KatingEntry_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_TF_KatingEntry_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_TF_KatingEntry_ID, Integer.valueOf(TF_KatingEntry_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_TF_KatingEntry_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set TF_KatingEntry_UU.
		@param TF_KatingEntry_UU TF_KatingEntry_UU	  */
	public void setTF_KatingEntry_UU (String TF_KatingEntry_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TF_KatingEntry_UU, TF_KatingEntry_UU);
	}

	/** Get TF_KatingEntry_UU.
		@return TF_KatingEntry_UU	  */
	public String getTF_KatingEntry_UU () 
	{
		return (String)get_Value(COLUMNNAME_TF_KatingEntry_UU);
	}
