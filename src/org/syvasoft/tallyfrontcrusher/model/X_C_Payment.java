...
public class X_C_Payment extends PO implements I_C_Payment, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20200614L;
...
// S
	...
	/** Set Auto Allocate.
		@param IsAutoAllocate 
		Auto allocates the respective open Invoices
	  */
	public void setIsAutoAllocate (String IsAutoAllocate)
	{
		set_Value (COLUMNNAME_IsAutoAllocate, IsAutoAllocate);
	}

	/** Get Auto Allocate.
		@return Auto allocates the respective open Invoices
	  */
	public String getIsAutoAllocate () 
	{
		return (String)get_Value(COLUMNNAME_IsAutoAllocate);
	}
