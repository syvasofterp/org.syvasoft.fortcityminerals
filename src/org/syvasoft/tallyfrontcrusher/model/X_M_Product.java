...
// N
	...
	/** Set Cash Sales Price.
		@param CashSalesPrice Cash Sales Price	  */
	public void setCashSalesPrice (BigDecimal CashSalesPrice)
	{
		set_Value (COLUMNNAME_CashSalesPrice, CashSalesPrice);
	}

	/** Get Cash Sales Price.
		@return Cash Sales Price	  */
	public BigDecimal getCashSalesPrice () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_CashSalesPrice);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set Set Opening Stock.
		@param SetOpeningStock 
		Sets Opening Stock for the Product
	  */
	public void setSetOpeningStock (String SetOpeningStock)
	{
		set_Value (COLUMNNAME_SetOpeningStock, SetOpeningStock);
	}

	/** Get Set Opening Stock.
		@return Sets Opening Stock for the Product
	  */
	public String getSetOpeningStock () 
	{
		return (String)get_Value(COLUMNNAME_SetOpeningStock);
	}
	...
	/** Set Tonnage Per Unit.
		@param TonnagePerUnit Tonnage Per Unit	  */
	public void setTonnagePerUnit (BigDecimal TonnagePerUnit)
	{
		set_Value (COLUMNNAME_TonnagePerUnit, TonnagePerUnit);
	}

	/** Get Tonnage Per Unit.
		@return Tonnage Per Unit	  */
	public BigDecimal getTonnagePerUnit () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_TonnagePerUnit);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
